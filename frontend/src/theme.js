...
const theme = createTheme({
  ...
  typography: {
    ...
    h1: { fontFamily: '"DM Sans", system-ui, sans-serif', fontWeight: 700 },
    h2: { fontFamily: '"DM Sans", system-ui, sans-serif', fontWeight: 700 },
    h3: { fontFamily: '"DM Sans", system-ui, sans-serif', fontWeight: 600 },
